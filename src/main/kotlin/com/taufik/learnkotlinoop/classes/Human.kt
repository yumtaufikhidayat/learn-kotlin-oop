...
// Note: If we extend interface, we still allowed to extend from parent class (super class).
class Human(override val name: String) : Go, MoveA, MoveB {
    ...
    override fun move() {
        // We can use super keyword to define which function in interface that has same named will be used.
